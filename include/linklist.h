...
//    void Delete_point(MESH_CARTESIAN& cartesian, FLOW_FIELD& flow_field);
    void Delete_point(MESH& MESH, FLOW_FIELD& flow_field);
    void Fresh_point(MESH& mesh, MESH_CARTESIAN& cartesian, FLOW_FIELD& flow_field);
    void Update_point(MESH& mesh, MESH_CARTESIAN& cartesian, FLOW_FIELD& flow_field);
};
